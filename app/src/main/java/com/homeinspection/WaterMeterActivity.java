                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        if (edtSerialNo.getText().toString().isEmpty()) {
                            Toast.makeText(WaterMeterActivity.this, "Please enter serial no", Toast.LENGTH_LONG).show();
                        } else if (edtLocation.getText().toString().isEmpty()) {
                            Toast.makeText(WaterMeterActivity.this, "Please enter location", Toast.LENGTH_LONG).show();
                        } else if (edtReading.getText().toString().isEmpty()) {
                            Toast.makeText(WaterMeterActivity.this, "Please enter reading", Toast.LENGTH_LONG).show();
                        } else {
                            if (getSharedPreferences("LOGIN_DETAIL", 0).getString("PROPERTY_TYPE", "").equalsIgnoreCase(chkCheck)) {
                                addWaterMeter();
                            } else {
                                Toast.makeText(WaterMeterActivity.this, "Sorry! You have started " +
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK) {
            ...
            if (requestCode == REQUEST_CAMERA) {
                ...
                selectedImage = getPath(WaterMeterActivity.this, selectedImageUri);
...
//                    }
    ...
    public void getWaterMeterCheckIn() {
        String tag_json_obj = "json_obj_req";
        String url = ApplicationData.serviceURL + "list_watermeter";
        ...
        StringRequest jsonObjReq = new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        Log.e("list_gasmeter", response.toString());
                        try {
                            ...
                            if (dataOb.getBoolean("result")) {
                                JSONArray meterArray = dataOb.getJSONArray("watermeter");
                                ...
                                if (!meterOb.getString("meter_image1").isEmpty()) {
                                    Picasso.with(WaterMeterActivity.this)
                                ...
                                if (!meterOb.getString("meter_image4").isEmpty()) {
                                    Picasso.with(WaterMeterActivity.this)
                                            .load(meterOb.getString("meter_image4"))
                                            .into(image4);
                                } else {
                                ...
                                getImage4 = meterOb.getString("meter_image4");
                                WATER_EDIT_ID = meterOb.getString("id");
                            } else {
                                Toast.makeText(WaterMeterActivity.this, "Check in history not available", Toast.LENGTH_LONG).show();
//                                edtSerialNo.setText("");
//                                edtLocation.setText("");
//                                edtReading.setText("");
//                                edtReading1.setText("");
...
//                                image4.setImageResource(R.drawable.ic_camera);
                            ...
                            if (e instanceof TimeoutError || e instanceof NoConnectionError) {
                                Toast.makeText(WaterMeterActivity.this, "Please check your internet connection!", Toast.LENGTH_LONG).show();
                            } else {
                                Toast.makeText(WaterMeterActivity.this, "Something is wrong Please try again!", Toast.LENGTH_LONG).show();
                            }
                        }
                    }
            ...
            public void onErrorResponse(VolleyError error) {
                mProgressDialog.dismiss();
                VolleyLog.e("list_gasmeter Error", "Error: "
                        + error.getMessage());
    ...
    public void getWaterMeterCheckOut() {
        String tag_json_obj = "json_obj_req";
        String url = ApplicationData.serviceURL + "list_watermeter";
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (dataOb.getBoolean("result")) {
                                ...
                                Toast.makeText(WaterMeterActivity.this, "Check out history not available", Toast.LENGTH_LONG).show();
//                                edtSerialNo.setText("");
//                                edtLocation.setText("");
//                                edtReading.setText("");
//                                edtReading1.setText("");
    ...
    public void getWaterMeter() {
        ...
        StringRequest jsonObjReq = new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>() {
                    ...
                    @Override
                    public void onResponse(String response) {
                        Log.e("list_watermeter", response.toString());
                        try {
                            mProgressDialog.dismiss();
                            JSONArray dataArr = new JSONArray(response.toString());
                            JSONObject dataOb = dataArr.getJSONObject(0);
            ...
            public void onErrorResponse(VolleyError error) {
                mProgressDialog.dismiss();
                VolleyLog.e("list_watermeter Error", "Error: "
                        + error.getMessage());
                // hide the progress dialog
                error.getCause();
                error.printStackTrace();
            ...
            protected Map<String, String> getParams() {
                Map<String, String> params = new HashMap<String, String>();
                params.put("propertyid", "" + getSharedPreferences("LOGIN_DETAIL", 0).getString("PROPERTY_TYPE_ID", ""));
                return params;
            }
        };
        jsonObjReq.setRetryPolicy(new DefaultRetryPolicy(20 * 1000, 1, 1.0f));
    ...
    public void addWaterMeter() {
        ...
        new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... params) {
                ...
                HttpPost httppost = new HttpPost(ApplicationData.serviceURL + "insertwater");

                try {

                    MultipartEntity entity = new MultipartEntity(HttpMultipartMode.BROWSER_COMPATIBLE);
                   /* if (CALL.equalsIgnoreCase("EDIT")) {
                        entity.addPart("electricid", new StringBody(""));
                        String imagedata = "";
                        try {
                            // if (!selectedImage1.isEmpty()) {
                            //imagedata= encodeToBase64(getBitmap(new File(selectedImage)));
                            //   entity.addPart("meter_imageupload1", new FileBody(new File(selectedImage1)));
                            // } else {
                            //  imagedata = getUrlContent(getImage);
                    ...
                    if (WATER_EDIT_ID.isEmpty()) {
                        entity.addPart("waterid", new StringBody("0"));
                    } else {
                        entity.addPart("waterid", new StringBody(WATER_EDIT_ID));
                    }
                    if (!selectedImage1.isEmpty()) {
                    ...
                    entity.addPart("type", new StringBody("WATER_METER"));
                    ...
                    in.close();
                    Log.e("add water meter data", sb.toString());
                    return sb.toString();

                } catch (Exception e) {
                    Log.e("add water meter problem", "" + e);
                    return "";
                }
            ...
            protected void onPostExecute(String result) {
                ...
                Log.e("add water meter", result.toString());
                try {
                    mProgressDialog.dismiss();
                    ...
                    if (msgOb.getBoolean("result")) {
                        ...
                        Toast.makeText(WaterMeterActivity.this, "Record saved successfully",
                                Toast.LENGTH_LONG).show();
                        finish();
                    } else {
                        Toast.makeText(WaterMeterActivity.this, "" + msgOb.getString("message"),
                                Toast.LENGTH_LONG).show();
                    }
            ...
            protected void onPreExecute() {
                // TODO Auto-generated method stub
                super.onPreExecute();
                mProgressDialog = new ProgressDialog(WaterMeterActivity.this);
                mProgressDialog.setTitle("");
                mProgressDialog.setCanceledOnTouchOutside(false);
                mProgressDialog.setMessage("Please Wait...");
                mProgressDialog.show();
