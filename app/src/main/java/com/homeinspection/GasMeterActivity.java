                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        if (edtSerialNo.getText().toString().isEmpty()) {
                            Toast.makeText(GasMeterActivity.this, "Please enter serial no", Toast.LENGTH_LONG).show();
                        } else if (edtLocation.getText().toString().isEmpty()) {
                            Toast.makeText(GasMeterActivity.this, "Please enter location", Toast.LENGTH_LONG).show();
                        } else if (edtReading.getText().toString().isEmpty()) {
                            Toast.makeText(GasMeterActivity.this, "Please enter reading", Toast.LENGTH_LONG).show();
                        } else {
                            if (getSharedPreferences("LOGIN_DETAIL", 0).getString("PROPERTY_TYPE", "").equalsIgnoreCase(chkCheck)) {
                                addGasMeter();
                            } else {
                                Toast.makeText(GasMeterActivity.this, "Sorry! You have started " +
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK) {
            ...
            if (requestCode == REQUEST_CAMERA) {
                ...
                selectedImage = getPath(GasMeterActivity.this, selectedImageUri);
...
//                    }
    ...
    public void getGasMeterCheckIn() {
        String tag_json_obj = "json_obj_req";
        String url = ApplicationData.serviceURL + "list_gasmeter";
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (dataOb.getBoolean("result")) {
                                JSONArray meterArray = dataOb.getJSONArray("gasmeter");
                                ...
                                if (!meterOb.getString("meter_image1").isEmpty()) {
                                    Picasso.with(GasMeterActivity.this)
                                ...
                                CALL = "EDIT";
                                getImage1 = meterOb.getString("meter_image1").isEmpty() ? getImage1 : meterOb.getString("meter_image1");
                                getImage2 = meterOb.getString("meter_image2").isEmpty() ? getImage2 : meterOb.getString("meter_image2");
                                getImage3 = meterOb.getString("meter_image3").isEmpty() ? getImage3 : meterOb.getString("meter_image3");
                                getImage4 = meterOb.getString("meter_image4").isEmpty() ? getImage4 : meterOb.getString("meter_image4");
                                GES_EDIT_ID = meterOb.getString("id");
                            } else {
                                Toast.makeText(GasMeterActivity.this, "Check in history not available", Toast.LENGTH_LONG).show();
//                                edtSerialNo.setText("");
//                                edtLocation.setText("");
//                                edtReading.setText("");
//                                edtReading1.setText("");
...
//                                image4.setImageResource(R.drawable.ic_camera);
                            ...
                            if (e instanceof TimeoutError || e instanceof NoConnectionError) {
                                Toast.makeText(GasMeterActivity.this, "Please check your internet connection!", Toast.LENGTH_LONG).show();
                            } else {
                                Toast.makeText(GasMeterActivity.this, "Something is wrong Please try again!", Toast.LENGTH_LONG).show();
                            }
                        }
                    }
    ...
    public void getGasMeterCheckOut() {
        String tag_json_obj = "json_obj_req";
        String url = ApplicationData.serviceURL + "list_gasmeter";
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (dataOb.getBoolean("result")) {
                                ...
                                Toast.makeText(GasMeterActivity.this, "Check out history not available", Toast.LENGTH_LONG).show();
//                                edtSerialNo.setText("");
//                                edtLocation.setText("");
//                                edtReading.setText("");
//                                edtReading1.setText("");
    ...
    public void addGasMeter() {
        ...
        new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... params) {
                ...
                HttpPost httppost = new HttpPost(ApplicationData.serviceURL + "insertgas");

                try {

                    MultipartEntity entity = new MultipartEntity(HttpMultipartMode.BROWSER_COMPATIBLE);
                    if (GES_EDIT_ID.isEmpty()) {
                        entity.addPart("gasid", new StringBody("0"));
                    } else {
                        entity.addPart("gasid", new StringBody(GES_EDIT_ID));
                    ...
                    entity.addPart("type", new StringBody("GAS_METER"));
                    ...
                    in.close();
                    Log.e("add gas meter data", sb.toString());
                    return sb.toString();

                } catch (Exception e) {
                    Log.e("add gas meter problem", "" + e);
                    return "";
                }
            ...
            protected void onPostExecute(String result) {
                ...
                Log.e("add gas meter", result.toString());
                try {
                    mProgressDialog.dismiss();
                    ...
                    if (msgOb.getBoolean("result")) {
                        ...
                        Toast.makeText(GasMeterActivity.this, "Record saved successfully",
                                Toast.LENGTH_LONG).show();
                        finish();
                    } else {
                        Toast.makeText(GasMeterActivity.this, "" + msgOb.getString("message"),
                                Toast.LENGTH_LONG).show();
                    }
            ...
            protected void onPreExecute() {
                // TODO Auto-generated method stub
                super.onPreExecute();
                mProgressDialog = new ProgressDialog(GasMeterActivity.this);
                mProgressDialog.setTitle("");
                mProgressDialog.setCanceledOnTouchOutside(false);
                mProgressDialog.setMessage("Please Wait...");
                mProgressDialog.show();
